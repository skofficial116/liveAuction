...
function Sidebar() {
  const menuItems = [
    { name: "Current Bid", path: "/admin/currentBid" },
    { name: "Auction History", path: "/admin/auctionHistory" },
    { name: "All Teams", path: "/admin/allTeams" },
    { name: "Manage Sets", path: "/admin/manageSets" },
    { name: "Manage Players", path: "/admin/managePlayers" },
