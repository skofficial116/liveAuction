...
function Sidebar() {
  const menuItems = [
    { name: "Current Bid", path: "/captain/currentBid" },
    { name: "Auction History", path: "/captain/auctionHistory" },
    { name: "All Teams", path: "/captain/allTeams" },
    { name: "My Team", path: "/captain/myTeam" },
  ];
