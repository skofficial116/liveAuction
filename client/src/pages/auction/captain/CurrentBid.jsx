...
const CurrentBidDetails = ({ player, timerEnd, remainingBudget }) => {
 ...
 <div className="fixed bottom-6 right-6 z-50">
  <button
    className="flex items-center gap-3 min-w-[180px] sm:min-w-[220px] py-3 sm:py-4 px-6 bg-gradient-to-r from-gray-900 to-black text-white font-bold text-lg sm:text-xl rounded-full shadow-2xl hover:shadow-3xl transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-gray-700"
  >
    <Gavel className="w-8 h-8 sm:w-9 sm:h-9 text-teal-400" />
    <span>Place Bid ₹{((player.currentBid || 0) + 0.5).toFixed(1)}CR</span>
  </button>
</div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-2">
            <CurrentBidDetails player={currentBidPlayer} timerEnd={timerEnd} remainingBudget={remainingBudget} />
